package com.juziwl.palette.weight;
...
public class PaletteView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        pushOrder(action, x, y);
        return true;
    }

    public void acceptOrder(int action, float x, float y) {
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                mLastX = x;
                mLastY = y;
    ...
    private void pushOrder(int action, float x, float y) {
        PushMsg pushMsg = new PushMsg();
        pushMsg.eventType = action;
        pushMsg.x = x;
        pushMsg.y = y;
